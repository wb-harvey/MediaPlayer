...
namespace ABX.MediaPlayer
{
    ...
    public enum NetworkStatistics
    {
        ...
        BytesReceived,
        /// <summary>
        /// The type of control protocol used to receive the data. The value indicates a member of the ABX.MediaPlayer.NetworkProtocol enumeration.
        /// </summary>
        Protocol,
        /// <summary>
    ...
    {
        /// <summary>
        /// Represents Advanced Audio Coding (.m4a) audio.
        /// </summary>
        AAC,
        /// <summary>
        /// Represents MPEG Audio Layer-3 (.mp3) audio.
        /// </summary>
        MP3,
        /// <summary>
        /// Represents Windows Media Audio 9 Professional or Windows Media Audio 9.1 Professional (.wma) audio.
        /// </summary>
        WMAudioV9
    }
    ...
    {
        /// <summary>
        /// Represents 32 Kbit (4000 bytes) per second.
        /// </summary>
        Kbps_032 = 4000,
        /// <summary>
        /// Represents 64 Kbit (8000 bytes) per second.
        /// </summary>
        Kbps_064 = 8000,
        /// <summary>
        /// Represents 96 Kbit (12000 bytes) per second.
        /// </summary>
        Kbps_096 = 12000,
        /// <summary>
        /// Represents 128 Kbit (16000 bytes) per second.
        /// </summary>
        Kbps_128 = 16000,
        /// <summary>
        /// Represents 160 Kbit (20000 bytes) per second.
        /// </summary>
        Kbps_160 = 20000,
        /// <summary>
        /// Represents 192 Kbit (24000 bytes) per second.
        /// </summary>
        Kbps_192 = 24000,
        /// <summary>
        /// Represents 256 Kbit (32000 bytes) per second.
        /// </summary>
        Kbps_256 = 32000,
        /// <summary>
        /// Represents 320 Kbit (40000 bytes) per second.
        /// </summary>
        Kbps_320 = 40000
    }
    ...
    {
        /// <summary>
        /// Represents H.264 (.mp4) video.
        /// </summary>
        H264,
        ///// <summary>
        ///// Represents H.265 video.
        ///// </summary>
        //H265,
        /// <summary>
        /// Represents Windows Media Video 9 (.wmv) video.
        /// </summary>
        WMV3
    }
    ...
    public sealed partial class Player : HideObjectMembers, IDisposable
    {
        ...
        // ABX.MediaPlayer Version
        internal const float                        VERSION                         = 1.6F;
        internal const string                       VERSION_STRING                  = "ABX.MediaPlayer 1.6";
        ...
        internal const string                       MP4_FILE_EXTENSION              = ".mp4"; // .h264 ?
        //internal const string                       H265_FILE_EXTENSION             = ".mp4"; // .h265 .hevc ?
        ...
        internal const string                       AAC_FILE_EXTENSION              = ".m4a"; // .aac ?
        internal const string                       WMA_FILE_EXTENSION              = ".wma";
        //internal const string                       FLAC_FILE_EXTENSION             = ".flac";
        //internal const string                       PCM_FILE_EXTENSION              = ".wav"; // .aiff, .pcm ?
        ...
        internal class SessionTeardownState
        {
            public IMFMediaSession Session;
            public IMFMediaSource Source;
            public IMFMediaSource WebcamAudio;
            public IMFMediaSource WebcamVideo;
            public bool WebcamAggregated;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the ABX.MediaPlayer.Player class (creates a new media player).
        /// </summary>
        public Player()
        {
        ...
        #region Public - ABX.MediaPlayer Version

        /// <summary>
        /// Gets the version number of this ABX.MediaPlayer library.
        /// </summary>
        ...
        /// <summary>
        /// Gets the version string of this ABX.MediaPlayer library.
        /// </summary>
        ...
        /// <summary>
        /// Stops playing chapters but continues playing the current media (applies only to chapters played using the Player.Play method).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value that indicates whether the player's pause mode is activated (default: false).
        /// </summary>
        public bool Paused
        {
            get
...
#pragma warning restore IDE0059 // Unnecessary assignment of a value
        ...
        /// <summary>
        /// Gets or sets a value that indicates whether to repeat a media chapter when finished (applies only to chapters played using the Player.Play method).
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of times that a chapter of the playing media has been repeated (applies only to chapters played using the Player.Play method).
        /// </summary>
...
#pragma warning restore IDE0059 // Unnecessary assignment of a value
        ...
        private HResult AV_PlayMedia()
        {
            ...
            mf_MediaSession.BeginGetEvent(mf_CallBack, mf_MediaSession);
...
#pragma warning restore IDE0059 // Unnecessary assignment of a value
        ...
        internal void AV_ProcessSessionClosed(IMFMediaSession session)
        {
            SessionTeardownState state = null;
            lock (_teardownStates)
            {
                for (int i = 0; i < _teardownStates.Count; i++)
                {
                    if (_teardownStates[i].Session == session)
                    {
                        state = _teardownStates[i];
                        _teardownStates.RemoveAt(i);
                        break;
                    }
                }
            }
            ...
            if (state != null)
            {
                if (state.Source != null)
                {
                    ...
                    Marshal.ReleaseComObject(state.Source);
                    if (state.WebcamAggregated)
                    {
                        if (state.WebcamAudio != null) { state.WebcamAudio.Shutdown(); Marshal.ReleaseComObject(state.WebcamAudio); }
                        if (state.WebcamVideo != null) { state.WebcamVideo.Shutdown(); Marshal.ReleaseComObject(state.WebcamVideo); }
                    }
                }
